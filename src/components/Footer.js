...
function Footer() {
  return (
    <div className='container_main bg-dark'>
    <footer className="row row-cols-1 row-cols-sm-2 row-cols-md-5 my-5">
   
    <div className="col mb-3">
      <h5>Contact</h5>
      
      <ul className="nav flex-row gap-4 mt-4">
      <li className="nav-item mb-2"><a href="https://github.com/Sagarrikame" className="py-5">
      ...
      <li className="nav-item mb-2"><a href="/" className="py-5">
          XXXXXX1619
      </a></li>
      </ul>
    </div>
